...
class SettingsWindow(QDialog):
    ...
    def __init__(self, parent=None, config=None, configs=None, current_config="alas"):
        ...
        mode_container.setContentsMargins(0, 0, 0, 0)
        ...
        self.connectionModeCombo.setFixedWidth(172)
        ...
        mode_hint_layout = QHBoxLayout()
        mode_hint_layout.setContentsMargins(114, 0, 0, 0)
        ...
        mode_hint_layout.addWidget(mode_hint, stretch=1)
        mode_container.addLayout(mode_layout)
        mode_container.addLayout(mode_hint_layout)
        ...
        runtime_port_container = QVBoxLayout()
        runtime_port_container.setContentsMargins(0, 0, 0, 0)
        runtime_port_container.setSpacing(4)
        ...
        runtime_port_hint_layout = QHBoxLayout()
        runtime_port_hint_layout.setContentsMargins(114, 0, 0, 0)
        ...
        runtime_port_hint.setWordWrap(True)
        runtime_port_layout.addWidget(runtime_port_label)
        runtime_port_layout.addWidget(self.runtimePortInput)
        runtime_port_layout.addStretch()
        runtime_port_hint_layout.addWidget(runtime_port_hint, stretch=1)
        runtime_port_container.addLayout(runtime_port_layout)
        runtime_port_container.addLayout(runtime_port_hint_layout)
        ...
        connection_panel_layout.addLayout(mode_container)
        connection_panel_layout.addLayout(ip_layout)
        connection_panel_layout.addLayout(port_layout)
        connection_panel_layout.addLayout(runtime_port_container)
